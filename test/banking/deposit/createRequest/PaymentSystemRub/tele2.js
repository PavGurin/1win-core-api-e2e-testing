...
describe.skip('Create deposite for tele2 - RUB @master', () => {
  ...
  it(' - (+) amount = 100.01 & wallet = (7)phone', async () => {
    const { data } = await banking.depositCreate('79772520000', paymentType, currency, 100.01);
    // console.log(data);
    successDepositCreate(data, currency,
      paymentType, 100.01);
  });
  ...
  it(' - amount = 2000 & wallet = (8)phone', async () => {
    const { data } = await banking.depositCreate('89772520000', paymentType, currency, 2000);
    // console.log(data);
    successDepositCreate(data, currency,
      paymentType, 2000);
  });
  ...
  it(' - max amount & wallet = numbers', async () => {
    const { data } = await banking.depositCreate('+79772520000', paymentType, currency, 15000);
    // console.log(data);
    successDepositCreate(data, currency,
      paymentType, 15000);
  });
  ...
  it(' - < max amount & wallet = numbers', async () => {
    const { data } = await banking.depositCreate('+79772520000', paymentType, currency, 14999);
    // console.log(data);
    successDepositCreate(data, currency,
      paymentType, 14999);
  });
  ...
  it(' - < max amount & wallet = valid short number', async () => {
    ...
    const { data } = await banking.depositCreate('+79772520', paymentType, currency, 14999);
    // console.log(data);
    successDepositCreate(data, currency,
      paymentType, 14999);
  });
...
describe.skip('Create deposite for tele2_rub invalid - RUB', () => {
  ...
  it(' - amount = 0', async () => {
    const { data } = await banking.depositCreate('+79772520000', paymentType, currency, 0);
    // console.log(data);
    checkErrMsg(data, 400, 'Bad request, amount is invalid');
  });

  it(' - amount = null', async () => {
    const { data } = await banking.depositCreate('+79772520000', paymentType, currency, null);
    // console.log(data);
    checkErrMsg(data, 400, 'Bad request, amount is required, no default value provided');
  });

  it(' - amount = empty', async () => {
    const { data } = await banking.depositCreate('+79772520000', paymentType, currency, ' ');
    // console.log(data);
    checkErrMsg(data, 400, 'Bad request, amount is invalid');
  });

  it(' - amount = undefined', async () => {
    const { data } = await banking.depositCreate('+79772520000', paymentType, currency, undefined);
    // console.log(data);
    checkErrMsg(data, 400, 'Bad request, amount is required, no default value provided');
  });

  it(' - amount = string', async () => {
    const { data } = await banking.depositCreate('+79772520000', paymentType, currency, 'fjfj');
    // console.log(data);
  ...
  it(' incorrect paymentType = tele2_rub_test', async () => {
    const { data } = await banking.depositCreate('+79001234567', 'tele2_rub_test', currency, 100);
    // console.log(data);
