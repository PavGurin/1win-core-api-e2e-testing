...
describe('Create deposite for beeline_rub - RUB @master', () => {
  ...
  it(' - < max amount & wallet = numbers', async () => {
    const { data } = await banking.depositCreateRequest(14999, '+79215598286',
...
describe.skip('Create deposite for beeline_rub invalid - RUB', () => {
  it(' - amount = 0', async () => {
    const { data } = await banking.depositCreateRequest(0, '+79215598286',
      paymentType, currency);
    // console.log(data);
  ...
  it(' - amount = null', async () => {
    const { data } = await banking.depositCreateRequest(null, '+79215598286',
      paymentType, currency);
    // console.log(data);
  ...
  it(' - amount = empty', async () => {
    const { data } = await banking.depositCreateRequest(' ', '79215598286',
      paymentType, currency);
    // console.log(data);
    checkErrMsg(data, 400, 'Bad request, amount is invalid');
  });
  ...
  it(' - amount = undefined', async () => {
    const { data } = await banking.depositCreateRequest(undefined, '79215598286',
      paymentType, currency);
    // console.log(data);
    checkErrMsg(data, 400, 'Bad request, amount is required, no default value provided');
  });
  ...
  it(' - amount = string', async () => {
    const { data } = await banking.depositCreateRequest('fjfj', '79215598286',
      paymentType, currency);
    // console.log(data);
  ...
  it(' - amount = string-number', async () => {
    const { data } = await banking.depositCreateRequest('50', '79215598286',
      paymentType, currency);
    // console.log(data);
  ...
  it(' - amount double < min amount', async () => {
    const { data } = await banking.depositCreateRequest(0.6, '79215598286',
      paymentType, currency);
    // console.log(data);
    checkErrMsg(data, 400, 'Bad request, amount is invalid');
  });
  ...
  it(' - amount < min amount', async () => {
    const { data } = await banking.depositCreateRequest(9, '79215598286',
      paymentType, currency);
    // console.log(data);
    checkErrMsg(data, 400, 'Неверная сумма');
  });
  ...
  it(' - amount > max amount', async () => {
    const { data } = await banking.depositCreateRequest(15001, '79215598286',
      paymentType, currency);
    // console.log(data);
    checkErrMsg(data, 400, 'Неверная сумма');
  });
  ...
  it(' - amount double > max amount', async () => {
    const { data } = await banking.depositCreateRequest(15000.000001, '79215598286',
      paymentType, currency);
    // console.log(data);
    checkErrMsg(data, 400, 'Неверная сумма');
  });
