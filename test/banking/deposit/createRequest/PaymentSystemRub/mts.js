...
describe.skip('Create deposite for mts_rub - RUB @master', () => {
  ...
  it(' - min amount & wallet = symbols', async () => {
    const { data } = await banking.depositCreate('+79001234567', paymentType, currency, 100);
    // console.log(data);
    successDepositCreate(data, currency,
      paymentType, 100);
  });
  ...
  it(' - > min amount & wallet = symbols', async () => {
    const { data } = await banking.depositCreate('+79001234567', paymentType, currency, 101);
    // console.log(data);
    successDepositCreate(data, currency,
      paymentType, 101);
  });
  ...
  it(' - max amount & wallet = numbers', async () => {
    const { data } = await banking.depositCreate('+79001234567', paymentType, currency, 14999);
    // console.log(data);
    successDepositCreate(data, currency,
      paymentType, 14999);
  });
  ...
  it(' - < max amount & wallet = numbers', async () => {
    const { data } = await banking.depositCreate('+79001234567', paymentType, currency, 14998);
    // console.log(data);
    successDepositCreate(data, currency,
      paymentType, 14998);
  });
  ...
  it(' - < max amount & wallet = valid short number', async () => {
    ...
    const { data } = await banking.depositCreate('+79001234', paymentType, currency, 14997);
    // console.log(data);
    successDepositCreate(data, currency,
      paymentType, 14997);
  });
...
describe.skip('Create deposite for mts_rub invalid - RUB', () => {
  ...
  it(' - amount < min amount', async () => {
    const { data } = await banking.depositCreate('+79001234567', paymentType, currency, 58);
    // console.log(data);
    checkErrMsg(data, 400, 'Неверная сумма');
  });
  ...
  it(' - incorrect paymentType = mts_rub_test', async () => {
    const { data } = await banking.depositCreate('+79001234567', 'mts_rub_test', currency, 100);
    // console.log(data);
